---
title: Analyzes system architecture, identifies technical debt, and plans incremental refactoring with rollback strategies
...
# Analyzes system architecture, identifies technical debt, and plans incremental refactoring with rollback strategies

<div class="tip custom-block" style="padding: 1rem;">
<strong>Agent:</strong> <code>architect</code> | <strong>Type:</strong> subagent | <strong>Read-Only:</strong> Yes
</div>
