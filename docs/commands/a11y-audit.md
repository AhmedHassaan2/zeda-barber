---
title: Accessibility audit following WCAG 2.1 AA guidelines
...
<strong>Command:</strong> <code>/a11y-audit</code> | <strong>Agent:</strong> <code>accessibility</code>
</div>
