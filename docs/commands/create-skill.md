---
title: Create a new OpenCode skill with proper structure and metadata
...
<strong>Command:</strong> <code>/create-skill</code> | <strong>Agent:</strong> <code>context-engineer</code>
</div>
...
```
/create-skill [options] [arguments]
```
