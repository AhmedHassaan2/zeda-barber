---
title: Comprehensive workspace health check with inventory, validation, cross-references, and fix recommendations
...
<strong>Command:</strong> <code>/health-check</code> | <strong>Agent:</strong> <code>context-engineer</code>
</div>
