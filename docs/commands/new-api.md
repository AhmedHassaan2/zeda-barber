---
title: Create a new Next.js Route Handler with proper structure and error handling
...
<strong>Command:</strong> <code>/new-api</code> | <strong>Agent:</strong> <code>backend</code>
</div>
