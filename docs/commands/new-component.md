---
title: Create a new React component with TypeScript, following project conventions
...
<strong>Command:</strong> <code>/new-component</code> | <strong>Agent:</strong> <code>frontend</code>
</div>
...
```
/new-component [options] [arguments]
```
