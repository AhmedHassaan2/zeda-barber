---
title: Perform comprehensive code review with security, performance, and quality analysis
...
<strong>Command:</strong> <code>/review</code> | <strong>Agent:</strong> <code>plan</code>
</div>
