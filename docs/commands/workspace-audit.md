---
title: Deep audit of workspace quality, consistency, and completeness with actionable recommendations
...
<strong>Command:</strong> <code>/workspace-audit</code> | <strong>Agent:</strong> <code>context-engineer</code>
</div>
...
```
/workspace-audit [options] [arguments]
```
