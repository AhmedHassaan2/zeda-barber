---
title: Validate workspace integrity, cross-references, naming, and metadata with automatic fix recommendations
...
<strong>Command:</strong> <code>/workspace-validate</code> | <strong>Agent:</strong> <code>context-engineer</code>
</div>
...
```
/workspace-validate [options] [arguments]
```
