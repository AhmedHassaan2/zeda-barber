---
title: Comprehensive workspace health validation, integrity checks, and automated fix recommendations
description: Comprehensive workspace health validation, integrity checks, and automated fix recommendations
---

# Comprehensive workspace health validation, integrity checks, and automated fix recommendations

<div class="tip custom-block" style="padding: 1rem;">
<strong>Skill:</strong> <code>validate-workspace</code> | <strong>Category:</strong> quality | <strong>Priority:</strong> high | <strong>Level:</strong> framework
</div>
