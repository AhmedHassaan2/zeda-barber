...
priority: high
dependencies: []
related_skills: ["authentication-patterns", "jwt-security", "vercel-deployment"]
related_agents: ["devops", "security"]
activation_rules:
  - keywords: ["env", "environment variable", "secret", "API key", "credential", "config", "validation"]
---
